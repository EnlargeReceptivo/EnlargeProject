                                        ...
                                        <form action="?controller=ServicoController&<?php echo isset($servico->id_servico) ? "method=atualizar&id={$servico->id_servico}" : "method=salvar"; ?>" method="post">
                                            <div class="col-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div>   
                                                        <span class="custom-checkbox">
                                                            <input type="checkbox" name="fg_exige_pickup" id="fg_exige_pickup" <?php if(isset($servico->fg_exige_pickup)){if ($servico->fg_exige_pickup == 1) { echo 'checked';}else{ echo'unchecked' ;}}?> >
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div>   
                                                        <span class="custom-checkbox">
                                                        <input type="checkbox" name="fg_ativo" id="fg_ativo" <?php  if(isset($servico->fg_ativo)){if($servico->fg_ativo == 1) { echo 'checked';}else{ echo'unchecked' ;}}?> >
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <h6 class="form-control">Privativo?<h6>
                                                        <div>   
                                                    <span class="custom-checkbox">
                                                        <input type="checkbox" name="fg_privativo" id="fg_privativo" <?php if(isset($servico->fg_privativo)){ if ($servico->fg_privativo == 1) { echo 'checked';}else{ echo'unchecked' ;}}?>>
                                            ...
                                            <div class="col-6">  
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="dt_janela_viagem_inicio" id="dt_janela_viagem_inicio" class="form-control input_password" 
                                                           value="<?php if (isset($servico->dt_janela_viagem_inicio)){
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="dt_deadline" id="dt_deadline" class="form-control" 
                                                           value="<?php 
                                                           if (isset($servico->dt_deadline)){
                                                               $dt_deadline1 = str_replace('-', '/', $servico->dt_deadline);
                                                                echo date('d/m/Y', strtotime($dt_deadline1));
                                                           }
