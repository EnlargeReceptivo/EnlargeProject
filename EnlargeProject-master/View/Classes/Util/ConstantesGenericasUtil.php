...
abstract class ConstantesGenericasUtil{
    ...
    public const TIPO_GET = ['USUARIOS', 'RESERVAS'];
    public const TIPO_POST = ['USUARIOS', 'TB_RESERVAS'];
    public const TIPO_DELETE = ['USUARIOS', 'RESERVAS'];
    public const TIPO_PUT = ['USUARIOS', 'TB_RESERVAS'];
    ...
    public const MSG_ERRO_LOGIN_SENHA_OBRIGATORIO = 'Dados invalidos!';
