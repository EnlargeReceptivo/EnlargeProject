...
class ReservasRepository {
    ...
    public function insereReserva($cod_tarifario, $horario, $nome_titular, $idade_titular, $idade_junior, $idade_senior, $qtde_pax) {
        $consultaInsert = 'INSERT INTO ' . self::TABELA . ' (cod_tarifario, horario, nome_titular, idade_titular, idade_junior, idade_senior, qtde_pax) ' . ' VALUES(:cod_tarifario, :horario, :nome_titular, :idade_titular, :idade_junior, :idade_senior, :qtde_pax)';
