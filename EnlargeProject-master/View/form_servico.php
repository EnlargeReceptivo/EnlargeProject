            ...
            <div class="table-title">
                <div class="row">   
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <a class="btn btn-danger" href="?controller=ServicoController&method=listar" type="submit">
                            ...
                            <div class="d-flex justify-content-center form_container">
                                <div class="col-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="ds_dias_semana" id="ds_dias_semana" class="form-control" value="<?php
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <p class="form-control">Exige Pickup?<p>
                                        <div>   
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <p class="form-control">Privativo?<p>
                                        <div>   
                                            <span class="custom-checkbox">
                                ...
                                <div class="col-6">  
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="nr_deadline" id="nr_deadline" class="form-control" 
                                               value="<?php echo isset($servico->nr_deadline) ? $servico->nr_deadline : null;
